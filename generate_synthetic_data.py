...
def resize_transform_obj(img, mask, longest_min, longest_max, transforms=False):
    ...
    transform = Al.Compose([
        ...
        Al.RandomGamma(),
        Al.transforms.RandomShadow (shadow_roi=(0, 0.5, 1, 1), num_shadows_lower=1, num_shadows_upper=2, shadow_dimension=5, always_apply=False, p=0.5),
        Al.transforms.Sharpen (alpha=(1, 1), lightness=(0.5, 1.0), always_apply=False, p=1),
        Al.transforms.FancyPCA (alpha=0.1, always_apply=False, p=0.5),
